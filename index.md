...
## Scientific output [Google Scholar](https://scholar.google.com/citations?user=csSxcRYAAAAJ&hl=en)
...
- *Is Academic Acceleration Leaving Peer Review in the Dust?*  
  [Read on Substack](https://unreasonabledoubt.substack.com/p/7a128d96-e8da-45d4-9d20-dfab237acbdd#footnote-1-104855675)

- *Generalised additive models and `geom_smooth()`*  
  [Read PDF](assets/gam_blog.pdf)

- *Prevalence of LLM use in science*  
  [Read on Substack](https://substack.com/home/post/p-175526606)

- *Probabilistic Network Models and the Role of Euler’s number*  
  [Read PDF](assets/PNM%20blog.pdf)
...
- **Workshop: Many Modelers Project**  
  Society for the Improvement of Psychological Science (SIPS), online.

### 2020

- **A Mayor’s depression? Scaling of urban mental health in UK cities**  
  Conference on Complex Systems, online.
